///I worte nothing found in this file, except for the last function. It is entirely the work of others besides that.
///The BFS for Adjacency Matrices requires a priority queue.
...
public class PriorityQueue<T> where T : IComparable<T>
{
    ...
    /// </param>
    /// <returns>
    /// Returns false if the list does not contain the value, otherwise it returns true.
    /// </returns>
